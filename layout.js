    ...
    <nav class="nav">
      <div class="nav__inner">
        ...
        <ul class="nav__links">
          ...
          <li><a href="/resume/" class="green ${active('resume')}">resume</a></li>
        </ul>
    ...
    <div class="menu" role="dialog" aria-modal="true">
      ...
      <div class="menu__inner">
        <ul class="menu__list">
          ...
          <li><a href="/resume/" class="green">resume</a></li>
        </ul>
      </div>
    </div>
  `;
    ...
    <section class="section cta">
      <div class="shell">
        ...
        <div class="cta__row">
          ...
          <a href="/contact/" class="btn-outline reveal">
            contact me
        ...
        <div class="shell">
          <div class="footer__grid">
            <div class="footer__col footer__col--brand">
              <a href="/" class="footer__logo">.heybharat</a>
            </div>
            ...
            <div class="footer__col">
              ...
              <ul class="footer__col-list">
                <li><a href="https://www.behance.net/bharataroradesign" target="_blank" rel="noopener">Behance</a></li>
                <li><a href="https://www.linkedin.com/in/bharat-arora027" target="_blank" rel="noopener">LinkedIn</a></li>
                <li><a href="https://instagram.com/bharataroradesign" target="_blank" rel="noopener">Instagram</a></li>
              </ul>
            </div>
            <div class="footer__col">
